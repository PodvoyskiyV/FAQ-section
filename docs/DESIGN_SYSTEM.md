...
| Белый | `#FFFFFF` | Фон секции, фон иконки при hover (основные вопросы) |
| Серый светлый | `#F3F4F6` | Фон активного блока, фон иконки, границы |
| Серый | `#f5f5f5` | Фон страницы, hover состояние кнопок |
| Тень | `rgba(0, 0, 0, 0.08)` | Тень секции FAQ |
